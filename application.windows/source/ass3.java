...
public class ass3 extends PApplet {
...
public void setup () 
{
  ...
  fishX = 0 - fishWidth;
  fishY = 0 + PApplet.parseInt(random(0, height / fishHeight)) * fishHeight;
...
public void setBarriers()
{
  ...
  {
    barrierX [i] = PApplet.parseInt(random(0, width / fishWidth)) * fishWidth; 
  }
  for (int i = 0; i < barrierY.length; i ++)
  {
    barrierY [i] = PApplet.parseInt(random(0, height / fishHeight)) * fishHeight;  
  }
}
public void setFood()
{
  ...
  {
    foodX [i] = PApplet.parseInt(random(0, width / fishWidth)) * fishWidth; 
  }
  for (int i = 0; i < foodY.length; i ++)
  {
    foodY [i] = PApplet.parseInt(random(0, height / fishHeight)) * fishHeight;  
  }
}

  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "ass3" });
  }
}
